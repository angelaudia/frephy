...
<form id="jadwalForm" action="/booking" method="post">
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="inputKonselor" id="inputKonselor" placeholder="Nama Konselor">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="inputKalender" class="col-sm-2 col-form-label">Kalender Waktu</label>
        <div class="col-sm-10">
            <input type="datetime-local" class="form-control" name="inputKalender" id="inputKalender">
        </div>
    </div>
    <div class="form-group row">
