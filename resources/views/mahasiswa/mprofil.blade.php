...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm">
            <div class="card">
                <div class="card-header">{{ __('Profil Mahasiswa') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @if($user->profil_img)
                                <img src="{{ asset('storage/profil_img/'.$user->profil_img) }}" class="img-thumbnail rounded mx-auto d-block">
                            @else
                                <img src="{{ asset('img/dashboard.jpg') }}" class="img-thumbnail rounded mx-auto d-block">
                            @endif

                        </div>
                        <div class="col-md-8">
                            <form method="POST" action="{{ route('profil-m.update', $user->id) }}" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
